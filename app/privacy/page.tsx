  ...
  return (
    <main className="mx-auto w-full max-w-2xl flex-1 px-4 py-10 text-sm leading-relaxed">
      ...
      <Section title="Who we are">
        <p>
          PayoutClear (&ldquo;we&rdquo;, &ldquo;us&rdquo;) is operated by George Beevor, trading as a sole trader in
          England. For any privacy question or request, contact chessli1995@gmail.com.
        </p>
      </Section>
      ...
      <Section title="Your rights (GDPR / CCPA)">
        <p>
          ...
          app (which triggers deletion as above) or by contacting us directly at chessli1995@gmail.com. Where a customer
